...
#ifndef IPV6_ADDRESS_LIST_H
#define IPV6_ADDRESS_LIST_H
 ...
 * \ingroup address
 *
 * \brief Implementation class of Ipv6AddressList
...
public:
   ...
   * to make use of this class's ability to track duplicates.  AddToTargetList
