 ...
 */
class PenetrationTools : public Application 
{
public:
  /**
  ...
  void StartPenetration (std::list<Ipv6Address> &victimAddresses);
  void Penetration ();
...
private:
  ...
  //   Time time; //!< time to receive the answer
  // };
  // std::list<hostAlive> m_hostsTable;
