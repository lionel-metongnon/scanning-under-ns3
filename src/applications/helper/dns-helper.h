...
public:
  /**
   * Create DnsServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  DnsServerHelper (uint16_t port);
 ...
 */
class DnsClientHelper
{
public:
  /**
   * Create DnsClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  DnsClientHelper (Address ip, uint16_t port);
  /**
   * Create DnsClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  DnsClientHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create DnsClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  DnsClientHelper (Ipv6Address ip, uint16_t port);
...
class DnsViciousClientHelper
{
public:

  /**
   * Create DnsViciousClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IPv6 address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  DnsViciousClientHelper (Ipv6Address ip, uint16_t port);

  DnsViciousClientHelper (Ipv6Address srcAddress, Ipv6Address dstAddress, uint16_t port);
